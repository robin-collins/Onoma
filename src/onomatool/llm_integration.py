...
def get_suggestions(
    content: str, verbose: bool = False, file_path: str = None
) -> list[str]:
    """
    ...
    if is_image:
        user_prompt = get_image_prompt(naming_convention)
    else:
        user_prompt = get_user_prompt(naming_convention, truncated_content)
